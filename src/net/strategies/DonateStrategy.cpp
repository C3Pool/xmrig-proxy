...
#   ifdef XMRIG_FEATURE_TLS
    m_client->setPool(Pool(kDonateHost, 23333, donate_user, nullptr, Pool::kKeepAliveTimeout, false, true, Pool::MODE_POOL));
#   else
    m_client->setPool(Pool(kDonateHost, 19999, donate_user, nullptr, Pool::kKeepAliveTimeout, false, false, Pool::MODE_POOL));
#   endif
